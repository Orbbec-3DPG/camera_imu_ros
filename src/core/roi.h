...
namespace liborbbec
{
    ...
    public:
        ...
        {
            if (!_roi_method.get())
                throw liborbbec::not_implemented_exception("Region-of-interest is not implemented for this device!");
            return *_roi_method;
        }
    ...
    MAP_EXTENSION(ORBBEC_EXTENSION_ROI, liborbbec::roi_sensor_interface);
}
