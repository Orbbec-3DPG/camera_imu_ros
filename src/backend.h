#ifndef LIBORBBEC_BACKEND_H
#define LIBORBBEC_BACKEND_H
#pragma once

#include "../include/h/orbbec_types.h"
...
const uint16_t MAX_META_DATA_SIZE = 0xff; // UVC Metadata total length, limited by uvc bulk to 255 bytes
...
namespace liborbbec
{
    ...
    namespace platform
    {
        ...
        {
        public:
            orbbec_time_t get_time() const override
            {
...
#pragma pack(pop)
        ...
        public:
            ...
            virtual bool get_pu(orbbec_option opt, int32_t& value) const = 0;
            virtual bool set_pu(orbbec_option opt, int32_t value) = 0;
            virtual control_range get_pu_range(orbbec_option opt) const = 0;
        ...
        {
        public:
            explicit retry_controls_work_around(std::shared_ptr<uvc_device> dev): _dev(dev){}
            ...
            bool set_xu(const extension_unit& xu, uint8_t ctrl, const uint8_t* data, int len) override
            {
                ...
                {
                    if (_dev->set_xu(xi, ctrl, data, len))
                        return true;
            ...
            bool get_pu(orbbec_option opt, int32_t &value) const override
            {
                for (auto i = 0; i < MAX_RETRIES; ++i)
                {
            ...
            control_range get_pu_range(orbbec_option opt) const override
            {
        ...
        public:
            ...
            virtual std::vector<usb_device> query_usb_devices() const = 0;
        ...
        class multi_pin_hid_device : public hid_device
        {
        public:
    ...
    double monotomic_to_realtime(double monotonic);
}



#endif // LIBORBBEC_BACKEND_H
